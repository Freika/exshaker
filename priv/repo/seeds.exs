...
Repo.get_by(Race, name: "Генератор ников для Дренеев") ||
  Repo.insert!(%Race{
    title: "Генератор ников для Дренеев (РП ники, генератор roleplay ников и имен)",
    name: "Генератор ников для Дренеев",
    ...
    slug: "draenei",
    description: "Генератор ников для Дренеев",
    game_id: wow.id
  })
...
Repo.get_by(Race, name: "Генератор ников для Воргенов") ||
  Repo.insert!(%Race{
    title: "Генератор ников для Воргенов(РП ники, генератор roleplay ников и имен)",
    name: "Генератор ников для Воргенов",
    ...
    slug: "worgen",
    description: "Генератор ников для Воргенов",
    game_id: wow.id
  })
